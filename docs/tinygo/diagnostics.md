...
Consult its
[README](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_load/README.md)
...
[board-probe tools](https://github.com/matthewdeanmartin/microcontroller/tree/main/nanacoin/tools/boardprobe).
