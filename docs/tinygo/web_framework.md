...
[API package](https://github.com/matthewdeanmartin/microcontroller/tree/main/nanacoin/internal/api)
and [board adapter](https://github.com/matthewdeanmartin/microcontroller/tree/main/nanacoin/internal/boardhttp).
