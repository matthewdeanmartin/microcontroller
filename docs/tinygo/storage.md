...
[RAM history](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin/RAM_HISTORY.md)
and [write memory](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin/WRITE_MEMORY.md).
