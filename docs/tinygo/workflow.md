...
Use the deploy script from `nanacoin/` after setting up the patched dependencies:
...
```powershell
python nanacoin/tools/boardprobe/serial_watch.py 30
```

The serial tools and their port-selection options are documented in the
[board-probe README](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin/tools/boardprobe/README.md).
