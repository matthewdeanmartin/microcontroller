...
is declared in `nanacoin/go.mod`. Treat these as the tested combination, not a
...
From `nanacoin/`, bootstrap the patched dependencies:
...
[patch notes](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin/patches/README.md)
