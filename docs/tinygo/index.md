...
| Directory in `nanacoin/` | Responsibility |
|---|---|
...
The separate [nanacoin_load project](https://github.com/matthewdeanmartin/microcontroller/tree/main/nanacoin_load)
contains Python/Locust tests and HTML reports. Python is test tooling, not
part of the firmware.

The [project README](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin/README.md)
