...
[Cargo.toml](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/Cargo.toml)
...
From `nanacoin/angular`, `npm run build` builds the shared client and
...
[build-esp32.sh](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/scripts/build-esp32.sh)
...
[web.rs](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/src/web.rs),
...
[connection security and USB recovery](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/CONNECTION_SECURITY.md).
...
[crate README](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/README.md)
