...
The [partition table](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/partitions.csv)
...
The implemented [NvsJournal](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/src/bin/esp32/journal.rs)
...
[checkpoint.rs](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/src/journal/checkpoint.rs)
...
The [retention contract](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/RETENTION.md)
describes retry generations, failure recovery and the desktop companion files.
The [checkpoint tests](https://github.com/matthewdeanmartin/microcontroller/blob/main/nanacoin_rs/tests/checkpoint.rs)
